 ...
 * @method
 * @name #getReposByOwnerByRepoCommits
 ...
 * @param {string} [until] - ISO 8601 Date - Only commits before this date will be returned.
...
function main(args) {
    return new Promise((resolve, reject) => {
        ...
        if (args['author'] !== undefined) {
            queryParameters['author'] = args['author'];
        }

        if (args['until'] !== undefined) {
            queryParameters['until'] = args['until'];
        }
