 ...
 * @method
 * @name #postReposByOwnerByRepoGitTags
 ...
 * @param {object} [body.tagger] - 
 * @param {string} [body.tagger.date] - ISO 8601 format: YYYY-MM-DDTHH:MM:SSZ
 * @param {string} [body.tagger.email] - 
 * @param {string} [body.tagger.name] - 
