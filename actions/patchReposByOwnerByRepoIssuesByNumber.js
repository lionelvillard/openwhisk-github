 ...
 * @method
 * @name #patchReposByOwnerByRepoIssuesByNumber
 * @param {string} owner - Name of repository owner.
 * @param {string} repo - Name of repository.
 * @param {integer} number - Number of issue.
 ...
 * @param {object} body - 
 * @param {string} [body.assignee] - 
 * @param {string} [body.body] - 
 * @param {array} [body.labels] - 
 * @param {number} [body.milestone] - 
