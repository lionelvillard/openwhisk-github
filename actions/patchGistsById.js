 ...
 * @param {} [body.files] - 
 * @param {string} [body.files.delete_this_file.txt] - 
 * @param {object} [body.files.file1.txt] - 
 * @param {string} [body.files.file1.txt.content] - 
 * @param {object} [body.files.new_file.txt] - 
 * @param {string} [body.files.new_file.txt.content] - 
 * @param {object} [body.files.old_name.txt] - 
 * @param {string} [body.files.old_name.txt.content] - 
 * @param {string} [body.files.old_name.txt.filename] - 
...
function main(args) {
    return new Promise((resolve, reject) => {
        ...
        if (args['id'] === undefined) {
            reject({
                error: 'Missing required integer parameter: id'
            });
            return;
        }
