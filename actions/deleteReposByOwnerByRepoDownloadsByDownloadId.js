 ...
 * @method
 * @name #deleteReposByOwnerByRepoDownloadsByDownloadId
 * @param {string} owner - Name of repository owner.
 * @param {string} repo - Name of repository.
 * @param {integer} downloadId - Id of download.
...
function main(args) {
    return new Promise((resolve, reject) => {
        ...
        if (args['downloadId'] === undefined) {
            reject({
                error: 'Missing required integer parameter: downloadId'
            });
            return;
        }

        path = path.replace('{downloadId}', args['downloadId']);
