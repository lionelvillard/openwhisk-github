 ...
 * @method
 * @name #getUsersByUsernameFollowingByTargetUser
...
function main(args) {
    return new Promise((resolve, reject) => {
        ...
        if (args['targetUser'] === undefined) {
            reject({
                error: 'Missing required string parameter: targetUser'
            });
            return;
        }

        path = path.replace('{targetUser}', args['targetUser']);
